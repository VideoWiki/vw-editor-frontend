...
<template>
  <div
    class="h-screen flex w-full bg-img  vx-row flex-col no-gutter justify-center items-center"
  >
    <div class="vx-col sm:w-1/2 md:w-1/2 lg:w-2/5 m-4">
      <vx-card >
        <div class="vx-card__title mb-6">
          <h2 class="text-center">Cast is launching soon</h2>
        </div>
        ...
        <div class="count-down text-center">
          ...
          <p>Cast will launch at <strong>{{DateString}} </strong> </p>
        </div>
      ...
      <!--   </div> -->
        <vs-divider position = 'center' class="mt-5"> Stay Updated </vs-divider> 
    <section>
...
export default {
  data() {
    return {
      value1: '',
      launchDate: new Date('12/12/2021 00:00:00')
    };
  },
  computed: {
    DateString() {
      return this.launchDate.toDateString()
    }
  },
  components: {
