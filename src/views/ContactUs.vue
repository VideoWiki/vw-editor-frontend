          ...
          <div class="vx-card__collapsible-content vs-con-loading__container">
            <div class="vx-card__body flex flex-wrap justify-between -m-3">
              <div class="w-full lg:w-1/2 p-3">
                <h3 class="mb-6 lg:text-left text-center">{{$t('ContactUs.Write.write')}}</h3>
                <div class="vx-row mb-6">
                  <div class="vx-col w-1/2">
                    <h6 class="mb-4">
                      {{$t('ContactUs.Write.name')}}<span class="text-danger">*</span>
                      <div class="h-2">
                        <span
                  ...
                  <div class="vx-col w-1/2">
                    <h6 class="mb-4">
                      {{$t('ContactUs.Write.email')}}<span class="text-danger">*</span>
                      <div class="h-2">
                        <span
                          class="text-danger text-sm"
              ...
              <div class="lg:w-1/2 w-full mx-auto p-3">
                <vx-card no-shadow class="address-box pl-8 h-full">
                  ...
                  <div class="mb-8">
                    ...
                    <p class="mb-4">
                      <span class="address-label">{{$t('ContactUs.Find.phone')}}</span>: {{$t('ContactUs.Find.phone_v')}}
                    </p>
                    <p class="mb-4">
                      <span class="address-label">{{$t('ContactUs.Find.email')}}</span>:
