                ...
                <form id="volunteer-form">
                  <div class="vx-row -m-2">
                    <div class="vx-col w-1/2 p-2">
                      <div class="mb-4">
                        <h6>{{$t('Teams.name')}}<span class="text-danger">*</span></h6>
                        <div class="h-2">
                          <span
                    ...
                    <div class="vx-col w-1/2 p-2">
                      <div class="mb-4">
                        <h6>{{$t('Teams.email')}}<span class="text-danger">*</span></h6>
                        <div class="h-2">
                          <span
                            class="text-danger text-sm"
                    ...
                    <div class="vx-col w-1/2 p-2">
                      <div class="mb-4">
                        <h6>{{$t('Teams.contact')}}<span class="text-danger">*</span></h6>
                        <div class="h-2">
                          <span
                            class="text-danger text-sm"
                    ...
                    <div class="vx-col w-1/2 p-2">
                      <div class="mb-4">
                        <h6>{{$t('Teams.resume')}}<span class="text-danger">*</span></h6>
                        <div class="h-2">
                          <span
                            class="text-danger text-sm"
