...
<template>
  <div class="cursor-pointer">
    ...
    >
    <!-- //shown only if sidebar is not active in a mobile device -->
   <!--  side bar is always active in desktops -->
    <vs-button  v-if="isMobile && !isChangelogSidebarActive" @click="isChangelogSidebarActive = true" class="bg-primary m-2" >
           More Updates
    </vs-button>
      <div
        id="changelog-app"
        ...
        <div
          ...
          class="border border-r-0 border-b-0 border-t-0 border-solid d-theme-border-grey-light no-scroll-content"
          style="height: 100%"
        >
  ...
  data() {
    return {
      ...
      logFilters: [
        ...
        { filterName: i18n.t('changelog.lbl0_opt3'), filter: 'fixed', icon: '' }
      ],
      logFilter: 'all'
    };
  },
